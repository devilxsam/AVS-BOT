...
BROADCAST_SUCCESS_MESSAGE = "𝘉𝘳𝘰𝘢𝘥𝘤𝘢𝘴𝘵 𝘤𝘰𝘮𝘱𝘭𝘦𝘵𝘦𝘥 𝘴𝘶𝘤𝘤𝘦𝘴𝘴𝘧𝘶𝘭𝘭𝘺."

NO_MESSAGE_PROVIDED_ERROR = "𝘌𝘳𝘳𝘰𝘳: 𝘕𝘰 𝘮𝘦𝘴𝘴𝘢𝘨𝘦 𝘱𝘳𝘰𝘷𝘪𝘥𝘦𝘥."

UNAUTHORIZED_ERROR_MESSAGE = "𝘠𝘰𝘶 𝘢𝘳𝘦 𝘯𝘰𝘵 𝘢𝘶𝘵𝘩𝘰𝘳𝘪𝘻𝘦𝘥 𝘵𝘰 𝘶𝘴𝘦 𝘵𝘩𝘪𝘴 𝘤𝘰𝘮𝘮𝘢𝘯𝘥. 𝘗𝘭𝘦𝘢𝘴𝘦 𝘤𝘰𝘯𝘵𝘢𝘤𝘵 𝘵𝘩𝘦 𝘢𝘥𝘮𝘪𝘯 @TADxAdminBot."

BROADCAST_ERROR_MESSAGE = "An error occurred during the broadcast."

PROCESSING_MESSAGE = "𝘝𝘪𝘥𝘦𝘰 𝘪𝘴 𝘤𝘶𝘳𝘳𝘦𝘯𝘵𝘭𝘺 𝘣𝘦𝘪𝘯𝘨 𝘱𝘳𝘰𝘤𝘦𝘴𝘴𝘦𝘥. 𝘗𝘭𝘦𝘢𝘴𝘦 𝘸𝘢𝘪𝘵 𝘧𝘰𝘳 𝘪𝘵 𝘵𝘰 𝘣𝘦 𝘴𝘦𝘯𝘵 𝘣𝘦𝘧𝘰𝘳𝘦 𝘶𝘴𝘪𝘯𝘨 𝘵𝘩𝘦 𝘤𝘰𝘮𝘮𝘢𝘯𝘥 𝘢𝘨𝘢𝘪𝘯."
